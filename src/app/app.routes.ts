...
export const APP_ROUTE: Route[] = [
  {
    ...
    children: [
      ...
      {
        path: 'widget',
        loadChildren: () => import('./widget/widget.routes')
          .then(m => m.WIDGET_ROUTE)
      },
      {
        path: 'ui',
      ...
      },
      {
        ...
        loadChildren: () => import('./forms/forms.routes')
          .then(m => m.FORMS_ROUTE)
      },
      {
        path: 'tables',
        loadChildren: () => import('./tables/tables.routes')
          .then(m => m.TEBLES_ROUTE)
      },
      {
        path: 'charts',
        loadChildren: () => import('./charts/charts.routes')
          .then(m => m.CHART_ROUTE)
      },
      {
        path: 'timeline',
        loadChildren: () => import('./timeline/timeline.routes')
          .then(m => m.TIMELINE_ROUTE)
      },
      {
        path: 'icons',
        loadChildren: () => import('./icons/icons.routes')
          .then(m => m.ICONS_ROUTE)
      },
      {
        path: 'extra-pages',
        loadChildren: () => import('./extra-pages/extra-pages.routes')
          .then(m => m.EXTRA_PAGES_ROUTE)
      },
      {
        path: 'maps',
      ...
      {
        path: 'multilevel',
        loadChildren: () => import('./multilevel/multilevel.routes')
          .then(m => m.MULTILEVEL_ROUTE)
      }
    ]
  },
  {
    ...
    loadChildren: () => import('./authentication/auth.routes')
      .then(m => m.AUTH_ROUTE)
  },
